 ...
 * @author Carlos
 */
public class VtnDetallesEventoSocial extends javax.swing.JFrame {

    /**
     * Creates new form VtnDetallesEventoSocial
     */
    public VtnDetallesEventoSocial() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Detalles Evento");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setText("Detalles del Evento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VtnDetallesEventoSocial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VtnDetallesEventoSocial().setVisible(true);
            }
        });
    }
