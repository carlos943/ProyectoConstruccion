...
public class VtnClientes extends javax.swing.JFrame {
    ...
    private void btnBuscarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarClienteActionPerformed
        ...
        try {
            ...
            LinkedList<Cliente> listaDeClientes = ctrlBuscarClientes.buscar(this.txtNombreCliente.getText());
    ...
    private void llenarTablaDeDatos(LinkedList<Cliente> listaDeClientes) {
        ...
        if (listaDeClientes != null) {
            ...
            for (Cliente cliente : listaDeClientes) {
                columnasDeDatos[0] = cliente.getNombrePersona();
                columnasDeDatos[1] = cliente.getDireccionPersona();
                columnasDeDatos[2] = cliente.getTelefonoPersona();
                columnasDeDatos[3] = cliente.getCorreoPersona();
    ...
    private Cliente obtenerInformacionDeRenglonSelecccionado() {
        ...
        int columnaNombre = 0, columnaDireccion = 1,
                columnaTelefono = 2, columnaCorreo = 3;
        ...
        return new Cliente(0,nombre, direccion, telefono, correo);
    }
